...
> 6  | await this.page.getByRole('link',{name:'Register'}).click();
     |                                                     ^ Error: locator.click: Test timeout of 30000ms exceeded.
  7  | await this.page.locator('input[name="username"]').fill(username);
  8  | await this.page.locator('input[name="password"]').fill(password);
  9  | await this.page.getByRole('button',{name:'Log In'}).click();
  10 | }
  11 | }
```